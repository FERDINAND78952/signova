...
MTN_ENABLED = config('MTN_ENABLED', default=True, cast=bool)  # Enable MTN Mobile Money by default
MTN_API_KEY = config('MTN_API_KEY', default='')  # MTN Mobile Money API Key
MTN_API_SECRET = config('MTN_API_SECRET', default='')  # MTN Mobile Money API Secret
FILE_UPLOAD_MAX_MEMORY_SIZE = 5242880  # 5MB
